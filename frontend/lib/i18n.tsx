...
const M: Record<string, { tr: string; en: string }> = {
  ...
  "ev.detail": { tr: "Detay", en: "Detail" },
  "dash.noTopics": {
    tr: "Hiç konu tanımlı değil — ODIN neyin sana uygun olduğunu bilemiyor. Konu ekle:",
    en: "No topics defined — ODIN can't tell what's relevant to you. Add some:",
  },
  ...
  "dash.catAll": { tr: "Tümü", en: "All" },
  "cat.technology": { tr: "Teknoloji", en: "Technology" },
  "cat.security": { tr: "Güvenlik", en: "Security" },
  "cat.ai": { tr: "Yapay zeka", en: "AI" },
  "cat.trends": { tr: "Trendler", en: "Trends" },
  "cat.devtools": { tr: "Geliştirici araçları", en: "Dev tools" },
  "cat.status": { tr: "Kesintiler", en: "Outages" },
  "cat.social": { tr: "Sosyal", en: "Social" },
  ...
  "bm.title": { tr: "Kıyas", en: "Benchmark" },
  "bm.subtitle": {
    tr: "Rakamların, akışından geçen tweetlere göre nerede duruyor",
    en: "Where your numbers sit against the tweets that scrolled past you",
  },
  "bm.corpus": { tr: "Kıyas havuzu", en: "Corpus" },
  "bm.you": { tr: "Senin yüzdeliğin", en: "Your percentile" },
  "bm.thin": {
    tr: "Kıyas için yeterli tweet görülmedi ({n}/{m}). Eklenti akışını okudukça dolar.",
    en: "Not enough tweets seen to compare ({n}/{m}). It fills as the extension reads your timeline.",
  },
  "bm.verdict.top": { tr: "üst %10", en: "top 10%" },
  "bm.verdict.above": { tr: "ortalamanın üstü", en: "above average" },
  "bm.verdict.typical": { tr: "tipik", en: "typical" },
  "bm.verdict.below": { tr: "altında", en: "below" },
  "st.title": { tr: "Ayarlar", en: "Settings" },
  "st.subtitle": {
  ...
  "you.subtitle": {
    tr: "ODIN'in senin hakkında bildiği her şey",
    en: "Everything ODIN knows about you",
  },
  "you.voice": { tr: "Tarzın", en: "Voice" },
  "you.numbers": { tr: "Rakamların", en: "Numbers" },
  "you.model": { tr: "Model", en: "Model" },
  "qp.title": { tr: "Kuyruk", en: "Queue" },
  "qp.subtitle": {
    tr: "Yazdığın ama henüz atmadığın her şey",
    en: "Everything you've written and not yet posted",
  },
  "qp.scheduled": { tr: "Zamanlanmış", en: "Scheduled" },
  "qp.drafts": { tr: "Taslaklar", en: "Drafts" },
  "qp.posted": { tr: "Paylaşıldı", en: "Posted" },
  "nav.feed": { tr: "Akış", en: "Feed" },
  "nav.you": { tr: "Sen", en: "You" },
  "nav.queue": { tr: "Kuyruk", en: "Queue" },
  "nav.settings": { tr: "Ayarlar", en: "Settings" },
  "fl.events": { tr: "Olaylar", en: "Events" },
  "fl.raw": { tr: "Ham akış", en: "Raw feed" },
  "fl.pulse": { tr: "X Nabız", en: "X Pulse" },
  "fl.recycle": { tr: "Tekrar kullan", en: "Recycle" },
  "fl.pulseHint": {
    tr: "X'te şu an hızlanan tweetler. Bir tanesine tıkla, konusu üretme kutusuna düşsün.",
    en: "Tweets accelerating on X right now. Click one to load its subject into the composer.",
  },
  "fl.recycleHint": {
    tr: "Tuttuğu kanıtlanmış kendi gönderilerin. Aynısını değil, aynı fikri yeni bir biçimde yaz — tekrar koruması seni uyarır.",
    en: "Your own posts that provably landed. Not the same tweet — the same point in a new shape; the repetition guard warns you either way.",
  },
  "fl.recycleEmpty": {
    tr: "Henüz beğeni almış gönderin görünmüyor.",
    en: "No posts with engagement yet.",
  },
  "cm.title": { tr: "Üret", en: "Compose" },
  "cm.topicPlaceholder": {
    tr: "Konu — ya da soldan bir karta tıkla",
    en: "Subject — or click a card on the left",
  },
  "cm.draftPlaceholder": { tr: "Tweet metni…", en: "Tweet text…" },
  "cm.score": { tr: "Puan", en: "Score" },
  "cm.fit": { tr: "tarz", en: "voice" },
  "cm.scoreWait": { tr: "Puan için biraz daha yaz…", en: "Write a bit more to score…" },
  "cm.scoreFailed": {
    tr: "Puanlama şu an çalışmıyor — yazmaya devam edebilirsin.",
    en: "Scoring is unavailable right now — you can keep writing.",
  },
  "cm.saveDraft": { tr: "Taslak kaydet", en: "Save draft" },
  "cm.saved": { tr: "Kaydedildi", en: "Saved" },
  "cd.title": { tr: "Bu hafta", en: "This week" },
  "cd.goal": { tr: "Haftalık hedef", en: "Weekly goal" },
  "cd.posted": { tr: "Paylaşılan", en: "Posted" },
  "cd.perDay": { tr: "Kalan günlere göre", en: "Per remaining day" },
  "cd.onTrack": { tr: "Hedefte", en: "On track" },
  "cd.behind": { tr: "Geride", en: "Behind" },
  "cd.quality": {
    tr: "{n} tanesi kıyas havuzunun ortancasını geçti",
    en: "{n} of them beat the corpus median",
  },
  "cd.daysLeft": { tr: "{n} gün kaldı", en: "{n} days left" },
  "cd.save": { tr: "Kaydet", en: "Save" },
  "dc.all": { tr: "Hepsi", en: "All" },
  "dc.fetch": { tr: "Şimdi çek", en: "Fetch now" },
  "dc.fetched": { tr: "{n} yeni içerik", en: "{n} new items" },
  "dc.fetchFail": { tr: "Çekilemedi", en: "Fetch failed" },
  "qu.queue": { tr: "Kuyruğa al", en: "Queue it" },
  "qu.queued": { tr: "Kuyrukta", en: "Queued" },
  "qu.unqueue": { tr: "Kuyruktan çıkar", en: "Unqueue" },
  "qu.bestHour": { tr: "En iyi saate", en: "At your best hour" },
  "qu.hint": {
    tr: "ODIN senin yerine paylaşmaz — saati gelince bildirim gönderir, sen basarsın.",
    en: "ODIN never posts for you — when the slot arrives it notifies you and you press Post.",
  },
  "pm.title": { tr: "Ne oldu?", en: "What happened?" },
  "pm.open": { tr: "Analiz et", en: "Analyse" },
  "pm.close": { tr: "Kapat", en: "Close" },
  "pm.lessons": { tr: "Çıkarımlar", en: "Takeaways" },
  "pm.firstHour": { tr: "İlk saat", en: "First hour" },
